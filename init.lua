...
local function start_sprint(player)
  ...
  if not sprinting[name].sprinting then
    ...
    sprinting[name].fov = math.min(sprinting[name].fov + 0.05, 1.2)
    player:set_fov(sprinting[name].fov, true, 0.15)
    sprinting[name].sprinting = true
  end
end

local function stop_sprint(player)
  local name = player:get_player_name()
  if sprinting[name].sprinting then
    if mod_player_monoids then
    ...
    sprinting[name].fov = math.max(sprinting[name].fov - 0.05, 1.0)
    player:set_fov(sprinting[name].fov, true, 0.15)
    sprinting[name].sprinting = false
  end
end
